...
- 세 보고서의 형식을 대조한 표와, 새 대화에서 만든 독립 검산 대조표, 그리고 스킬 개선 기록
- (선택 심화) 에이전트와 분업으로 만든 두 번째 스킬 `practice-log`
...
![그림 4-4. 하나의 스킬과 세 데이터: 무엇이 같고 무엇이 다른가](figures/fig04_three_reports.png)
...
![그림 4-5. 스킬의 테스트와 개선 순환](figures/fig04_skill_test_loop.png)
