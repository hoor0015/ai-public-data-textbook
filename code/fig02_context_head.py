# -*- coding: utf-8 -*-
# 2주차·13주차 맥락창 개념도: 머리 그림(figures/head_brain_src.png)의 뇌 구역을 찾아 색과 글씨를 얹는다
# 산출: fig02_context_head.png (머리 안에 무엇이 있나)
#       fig02_compact_clear.png (compact와 clear의 차이)
#       fig13_orchestrator_heads.png (본 에이전트와 서브에이전트)
#       fig13_agent_features.png (머리로 보는 에이전트 기능 네 가지)
#       fig02_more_features.png (되감기·훅·옆에서 묻기·자동 메모리)
...
fig.savefig(FIG / "fig02_context_head.png", dpi=150, bbox_inches="tight")
plt.close(fig)
...
fig.savefig(FIG / "fig02_compact_clear.png", dpi=150, bbox_inches="tight")
plt.close(fig)
...
fig.savefig(FIG / "fig13_orchestrator_heads.png", dpi=150, bbox_inches="tight")
plt.close(fig)
...
fig.savefig(FIG / "fig13_agent_features.png", dpi=150, bbox_inches="tight")
plt.close(fig)
...
fig.subplots_adjust(hspace=0.15, wspace=0.05)
fig.savefig(FIG / "fig02_more_features.png", dpi=150, bbox_inches="tight")
plt.close(fig)
