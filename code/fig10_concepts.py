...
fig.savefig(FIG / "fig10_population_sample.png", dpi=150, bbox_inches="tight")
plt.close(fig)
...
fig.savefig(FIG / "fig10_confounder.png", dpi=150, bbox_inches="tight")
plt.close(fig)
