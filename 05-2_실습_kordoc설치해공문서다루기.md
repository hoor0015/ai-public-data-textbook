...
- (2.8의 과제) `data/gongik/`의 공시 서식 3,103장을 집계해 양식대로 만든 보고서 hwpx
...
**검증과 채점의 기준.** 제출 전에 셋을 확인한다. 첫째, 보고서의 모든 숫자가 법인별 집계표에서 다시 계산되는가. 표의 법인 수와 집계표의 행 수가 같아야 한다. 둘째, 상위 법인 표의 한 곳을 골라 그 법인의 원본 xls를 열어 보고서의 값과 같은지 본다. 셋째, 문제점 절의 개수가 각각 무엇을 세어 나온 것인지 말할 수 있는가. 채점은 숫자가 저자의 것과 같은지가 아니라 다음 넷을 본다. 어느 칸에서 값을 뽑고 무엇을 뺐는지가 개요에 적혀 있는가, 평균과 중앙값이 함께 있고 차이가 설명되어 있는가, 문제점이 실제로 센 개수로 적혀 있는가, hwpx가 한글에서 열리고 양식의 절과 표가 갖추어져 있는가. 첫 제출본이 이 넷을 채우면 통과이고, 통과한 뒤에는 같은 보고서의 품질을 한 단계 올려 다시 낸다. 방향은 자유롭게 고르되 예를 들면 요약 상자를 과장님이 30초에 읽을 수 있게 다듬는 것, 상위 법인 표에 총자산과 수익을 나란히 두어 순위가 항목마다 다름을 보이는 것, 문제점 절의 개수마다 세는 방법을 붙이는 것, 표의 서식이나 결재란처럼 문서의 꼴을 과의 양식에 더 가깝게 하는 것이다. 두 번째 제출본에는 무엇을 왜 바꾸었는지 한 문단을 붙이며, 바꾼 것이 읽는 사람의 부담을 실제로 줄였는지와 바꾸는 과정에서 숫자가 어긋나지 않았는지를 본다.
