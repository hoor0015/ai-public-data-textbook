...
fig.tight_layout()
fig.savefig(FIG / "fig14_report_pyramid.png", dpi=150, bbox_inches="tight")
plt.close(fig)
...
fig.tight_layout()
fig.savefig(FIG / "fig14_triple_check.png", dpi=150, bbox_inches="tight")
plt.close(fig)
...
fig.tight_layout()
fig.savefig(FIG / "fig14_repro_package.png", dpi=150, bbox_inches="tight")
plt.close(fig)
