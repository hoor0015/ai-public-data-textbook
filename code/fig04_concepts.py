# 4주차 1회차 개념도 생성 (Skill: 3층 구조, 작동 흐름)
...
fig.savefig(FIG / "fig04_three_layers.png", dpi=150, bbox_inches="tight")
plt.close(fig)
...
fig.savefig(FIG / "fig04_skill_flow.png", dpi=150, bbox_inches="tight")
plt.close(fig)
