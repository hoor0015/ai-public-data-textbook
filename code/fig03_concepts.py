...
fig.savefig(FIG / "fig03_terminal_shell.png", dpi=150, bbox_inches="tight")
plt.close(fig)
...
ax.text(5.0, 1.6, "서로 건드리지 않는다.\n한쪽을 바꿔도 다른 쪽은 그대로 작동한다.",
        ...
        bbox=dict(fc="#f7f7fc", ec="#d9d9e3", boxstyle="round,pad=0.5"))
fig.tight_layout()
fig.savefig(FIG / "fig03_venv.png", dpi=150, bbox_inches="tight")
plt.close(fig)
...
fig.savefig(FIG / "fig03_folder.png", dpi=150, bbox_inches="tight")
plt.close(fig)
